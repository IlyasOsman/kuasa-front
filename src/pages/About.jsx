...
import {nobgrocket} from "../assets";

export const About = () => {
  return (
    <div className={`xl:container xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4`}>
      <h1 className="font-normal font-poppins text-[16px] leading-3 text-white cursor-pointer pb-2">
        About
      </h1>
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        ...
        <div className="w-full lg:w-6/12">
          <img className="" src={nobgrocket} alt="no background rocket" />
        </div>
      </div>
      ...
      <div className="relative mt-24">
        <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
          <div className="z-20 w-12 h-12 bg-gray-800 rounded-full flex justify-center items-center">
            ...
            >
              <circle cx="24" cy="24" r="24" fill="#33bbcf" />
              <path
                d="M5 5V21"
                stroke="white"
                strokeWidth="2.75"
      ...
      <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
        <div>
          ...
          <p className="font-normal text-base leading-6 text-dimWhite mt-6">
            Founded to Unleashing Potential through Projects and Innovation.
          </p>
        </div>
        <div>
          <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-secondary mt-6">
      ...
      <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
        <div className="w-full lg:w-6/12">
          <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-secondary">
            Our Mission
          </h2>
        ...
        <div className="w-full lg:w-6/12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-secondary">
                  Team
                </p>
